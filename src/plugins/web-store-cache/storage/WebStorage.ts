import type { StoreValue, TypedStorage } from "../core";

interface StorageListener {
  (this: Window, event: WindowEventMap["storage"]): unknown;
}

export interface WebStorageEvent<T extends StoreValue>
  extends Omit<StorageEvent, "storageArea" | "oldValue" | "newValue"> {
  oldValue: T | null;
  newValue: T | null;
}
